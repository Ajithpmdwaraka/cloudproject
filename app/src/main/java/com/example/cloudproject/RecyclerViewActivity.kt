...
import com.example.cloudproject.model.ProductAdapter
import com.example.cloudproject.model.ProductItem
...
class RecyclerViewActivity : AppCompatActivity() {
    ...
    private lateinit var pd_arrayList : ArrayList<ProductItem>
            ...
            override fun onEvent(value: QuerySnapshot?, error: FirebaseFirestoreException?) {
                ...
                for(dc:DocumentChange in value?.documentChanges!!){
                    if (dc.type == DocumentChange.Type.ADDED){
                        pd_arrayList.add(dc.document.toObject(ProductItem::class.java))
